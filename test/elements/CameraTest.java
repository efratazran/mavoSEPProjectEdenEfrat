...
class CameraTest {
    ...
    public void testConstructRayThroughPixel() {
        Camera camera = new Camera.Builder(Point3D.ZERO, new Vector(0, 0, 1), new Vector(0, -1, 0))
                .setDistance(10)
                .build();
