...
public class CameraRayIntersectionsIntegrationTests {
    ...
    private void assertCountIntersections(Camera cam, intersectable geo, int expected) {
        ...
        for (int i = 0; i < nY; ++i) {
            for (int j = 0; j < nX; ++j) {
                // points intersection for ray in pixel (i,j)
    ...
    public void cameraRaySphereIntegration() {
        Camera cam1 = new Camera.Builder(Point3D.ZERO, new Vector(0, 0, -1), new Vector(0, -1, 0))
                .build();
        Camera cam2 = new Camera.Builder(new Point3D(0, 0, 0.5), new Vector(0, 0, -1), new Vector(0, -1, 0))
                .build();
    ...
    public void cameraRayPlaneIntegration() {
        Camera cam = new Camera.Builder(Point3D.ZERO, new Vector(0, 0, -1), new Vector(0, -1, 0))
                .build();
